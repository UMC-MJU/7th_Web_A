...
const MovieDetailPage = () => {
    ...
    // 영화 상세 정보 가져오기
    const { data: details, isLoading: loadingDetails, isError: errorDetails } = useGetMovieDetails(movieId, apiKey);
    
    // 출연진 정보 가져오기
    const { data: credits, isLoading: loadingCredits, isError: errorCredits } = useGetMovieCredits(movieId, apiKey);
